...
- **Data Science Fellowship (DSF, AKA 펠로우쉽)**
...
- **오픈랩**
오픈랩은 특정한 분야에 대해 오픈된 형태로 다루는 그룹으로, 한 분야를 지속적으로 학습하거나 연구개발하는 데 적합한 프로그램입니다. 가입 조건을 "오픈랩 모임 4회 이상 참가"처럼 두어 기존처럼 기수별로 신청 및 선정하는 것이 아니라, 참여 의지와 노력만으로 멤버로 편입이 가능한 형태입니다.
- **리서치**
리서치는 특정한 문제에 대해서 연구개발하는 팀으로, 흥미로운 주제의 연구, 문제 해결, 프로토타입 개발, 논문 작성 등을 진행하는 프로그램입니다. 주제만으로도 가치를 갖는 연구를 진행하거나, 문제를 해결하거나 개발하는 것을 통해 이슈가 될만한 것을 다룰 수 있도록 많은 시간과 집중을 요합니다.
### 가짜연구소 커뮤니티
- **마법 학교**
...
- **각종 온/오프 행사**
컨퍼런스(PseudoCon), 밋업(Kaggle Days Meetup in Seoul), 튜토리얼, 해커톤, 라이트닝톡과 같은 지식 공유 및 정보 전달의 행사와 번개모임, 가짜운동회와 같은 네트워킹 중심의 행사를 진행하고 있습니다. 다양한 시도적인 행사들을 진행하고 있으니, 관심가져주세요!
### 가짜연구소 이니셔티브
<br/>
...
## 가짜연구소 디스코드 채널
가짜연구소의 다양한 소식을 들으실 수 있으며, 가끔씩 채용사이트에도 올라오지 않는 고오급 채용 정보들을 얻으실 수 있습니다! 질문방을 active하게 운영중이며, '검색하면 다 나와요'는 지양하고 있습니다! 온라인 모각코, 가짜반상회(기월회) 등의 행사도 진행됩니다. 이전에 사용하던 슬랙에서 디스코드로 이전하였습니다.  ([가짜연구소 디스코드 바로가기](https://discord.gg/EPurkHVtp2))  
<br/>
